    ...
    <Grid container direction="column" alignItems="center" justifyContent="space-between" style = {{height:"100vh"}}>
        <Grid item className={classes.header}>
            <Grid container direction="row" alignItems="center" justifyContent="space-between">
                ...
                <Grid item>
                    <RegisterButton variant="contained" to="/register">Register</RegisterButton>
                </Grid>
            </Grid>
        </Grid>
        <Grid item>
           <Grid container direction="column" alignItems="center" justifyContent="center" spacing={2} className={classes.form}>
                <Grid item>
                    <Typography variant = "h5">Welcome back! Please Login to your account</Typography>
                </Grid>
               <Grid item>
               ...
               <Grid item>
                    <Typography variant="body2" style={{color: "red"}}>{errorText}</Typography>
               </Grid>
               <Grid item>
                   <RegisterButton onClick={handleLogin} >Login</RegisterButton>
               </Grid>
               <Grid item>
                    <Typography variant="body2">Don't have an account yet? <Link to='/register'>Register here</Link> </Typography>
               </Grid>
           </Grid>
        </Grid>
